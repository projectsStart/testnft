    ...
    <Spacer></Spacer>
                <Row gap={3}>
                    <Col>                            
                            ...
                            <Text style={{color:"#fff",fontSmooth:"always",fontFamily:"SF Pro Display"}}>The blockchain agnostic marketplace. The token with endless posibilities. nfts are more than just art. Its meant to change the way humans establish ownership of an asset beyond paper.</Text>
                       </Col>
                    </Row>
                    <Row gap={3}>
                    <Col>
